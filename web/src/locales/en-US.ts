export default {
  ...
  drama: {
    ...
    styleCustomPlaceholder: 'Custom style (e.g. Cyberpunk, Ink painting)',
    styles: {
      ghibli: 'Ghibli',
      guoman: 'Guoman',
      wasteland: 'Wasteland',
    ...
    management: {
      ...
      filename: 'Filename',
      databaseAssociation: 'Database Association',
      ...
      confirmDeleteSelectedImages: 'Are you sure you want to delete the selected {count} images?',
      confirmDeleteSelectedVideos: 'Are you sure you want to delete the selected {count} videos?',
      imageDeleted: 'Image deleted',
      videoDeleted: 'Video deleted',
      imagesDeleted: '{count} images deleted',
      videosDeleted: '{count} videos deleted',
      selectImagesToDelete: 'Please select images to delete first',
      selectVideosToDelete: 'Please select videos to delete first',
      imagesRefreshed: 'Image list refreshed',
      videosRefreshed: 'Video list refreshed',
      filePath: 'File Path',
      fileSize: 'File Size',
      associationStatus: 'Association Status',
      associatedType: 'Associated Type',
      associatedId: 'Associated ID',
      associatedTypeImage: 'Image Generation Record',
      associatedTypeCharacter: 'Character',
      associatedTypeScene: 'Scene',
      associatedTypeProp: 'Prop',
      failedToRefreshImages: 'Failed to refresh image list',
      failedToRefreshVideos: 'Failed to refresh video list',
      failedToDeleteImage: 'Failed to delete image',
      failedToDeleteImages: 'Failed to delete images',
  ...
  workflow: {
    ...
    characterDescriptionPlaceholder: 'Appearance description for reference image (three-view, white background)',
    backgroundStory: 'Background Story',
    backgroundStoryPlaceholder: 'Character background and relationships in the script',
    viewSide: 'Side View',
    viewFront: 'Front View',
    viewBack: 'Back View',
    singleCompositeThreeView: 'Single composite three-view sheet (side/front/back, white background)',
  ...
  editor: {
    ...
    promptHint: '① Prompts determine image effect; you can edit and optimize manually.',
