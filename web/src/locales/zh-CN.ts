export default {
  ...
  drama: {
    ...
    styleCustomPlaceholder: '输入自定义风格（如：赛博朋克、水墨风）',
    videoAspectRatio: '视频宽高比',
    ...
    management: {
      ...
      previewVideo: '预览视频',
      filename: '文件名',
      databaseAssociation: '数据库关联',
      associated: '已关联',
      notAssociated: '未关联',
      confirmDeleteImage: '确定要删除此图片吗？',
      confirmDeleteVideo: '确定要删除此视频吗？',
      confirmDeleteSelectedImages: '确定要删除选中的 {count} 张图片吗？',
      confirmDeleteSelectedVideos: '确定要删除选中的 {count} 个视频吗？',
      imageDeleted: '图片已删除',
      videoDeleted: '视频已删除',
      imagesDeleted: '{count} 张图片已删除',
      videosDeleted: '{count} 个视频已删除',
      selectImagesToDelete: '请先选择要删除的图片',
      selectVideosToDelete: '请先选择要删除的视频',
      imagesRefreshed: '图片列表已刷新',
      videosRefreshed: '视频列表已刷新',
      filePath: '文件路径',
      fileSize: '文件大小',
      associationStatus: '关联状态',
      associatedType: '关联类型',
      associatedId: '关联ID',
      associatedTypeImage: '图片生成记录',
      associatedTypeCharacter: '角色',
      associatedTypeScene: '场景',
      associatedTypeProp: '道具',
      failedToRefreshImages: '刷新图片列表失败',
      failedToRefreshVideos: '刷新视频列表失败',
      failedToDeleteImage: '删除图片失败',
      failedToDeleteImages: '删除图片失败',
      failedToDeleteVideo: '删除视频失败',
      failedToDeleteVideos: '删除视频失败',
    }
  },
  character: {
    title: '角色管理',
  ...
  workflow: {
    ...
    shotNumberTitle: '镜头 {n} {title}',
    untitledShot: '未命名',
    charactersUnit: '个角色',
    scenesUnit: '个场景',
    systemPrompt: '系统提示词',
    associatedCharacters: '关联角色',
    associatedScenes: '关联场景',
    clickToBindCharacter: '点击绑定角色',
    clickToBindScene: '点击绑定场景',
    ...
    characterDescriptionPlaceholder: '外貌描述，用于生成角色参考图（三视图、白底）',
    backgroundStory: '背景故事',
    backgroundStoryPlaceholder: '角色背景与剧本中的关系',
    viewSide: '侧面视图',
    viewFront: '正面视图',
    viewBack: '背面视图',
    singleCompositeThreeView: '单张三视图合成图（侧面/正面/背面，白底）',
    changeOne: '换一张',
    history: '历史',
    manualUpload: '手动上传',
    selectAge: '请选择年龄',
  ...
  video: {
    ...
    videoEditing: '视频编辑',
    batchEditing: '批量编辑',
    noMediaResource: '暂无媒体资源',
    resourcesByShot: '分镜资源',
    batchGenerateImage: '生图',
